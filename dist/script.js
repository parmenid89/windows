...
// jshint -W101
var clearFields = function clearFields(inputsSelector, tabsSelector, contentSelectorForTabs, activeClassTab, startedNumberOfTab) {
...
/* harmony default export */ __webpack_exports__["default"] = (clearFields);
...
/* harmony import */ var _clearFields__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./clearFields */ "./src/js/modules/clearFields.js");
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData("./assets/server.php", formData).then(function (res) {
        ...
        Object(_clearFields__WEBPACK_IMPORTED_MODULE_8__["default"])('input', '.balcon_icons_img', '.popup_calc_content', 'do_image_more', 0);
        setTimeout(function () {
          statusMessage.remove();
        }, 2000);
        Object(_modals__WEBPACK_IMPORTED_MODULE_7__["autoCloseModal"])('[data-modal]');
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _clearFields__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./clearFields */ "./src/js/modules/clearFields.js");
      ...
      item.addEventListener('click', function (elem) {
        ...
        if (item !== btnCalc && item !== btnEnd) {
          ...
          if (item === btnCalc && state.width && state.height) {
            ...
            Object(_clearFields__WEBPACK_IMPORTED_MODULE_2__["default"])('input', '.balcon_icons_img', '.popup_calc_content', 'do_image_more', 0);
          }
...
var timer = function timer(id, deadline) {
  ...
  var getTimeRemaining = function getTimeRemaining(endTime) {
    var t = Date.parse(endTime) - Date.parse(new Date()),
        ...
        hours = Math.floor((t - 3600000) / (1000 * 60 * 60) % 24),
